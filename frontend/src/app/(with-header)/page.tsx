    ...
    return (
        <div className={"flex items-center flex-col gap-x-5 justify-center"}>
            <main className={"flex items-center mt-14 flex-col justify-center"}>
                ...
                <h1 className={"text-black text-6xl mt-6 font-extrabold text-center max-w-4/7"}>Master Your Career
                    Flow. <a className={"text-blue-800"}> Sync, Track, and Tailor </a> Every Application.</h1>
                <p className={"text-black/50 font-semibold max-w-3/7 mt-6 text-center"}>The precision curator for modern
