...
export default function DashboardHeader() {
    ...
    return (
        <header
            className={"flex w-full items-center gap-x-8 justify-start border-b border-b-black/10 bg-white px-5 py-4 shrink-0 z-10"}>

            <div className={"flex items-center justify-start flex-1 min-w-0 gap-x-4"}>
                <div
                    className={"flex min-w-0 flex-1 max-w-full items-center gap-x-2 bg-[#ededed] rounded-md shadow-sm px-5 py-2 justify-start"}>
